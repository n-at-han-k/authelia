...
const PasswordMeter = function (props: Props) {
    ...
    return (
        <div className="w-full">
            <div
                className="mt-0.5 h-[5px] transition-[width] duration-500 ease-linear"
                style={{
            ...
            {(feedbackTitle !== "" || feedback !== "") && (
                <Alert>
                    {feedbackTitle !== "" && (
                        <AlertTitle className="text-left text-[0.85rem] whitespace-break-spaces">
                            <p>{feedbackTitle}</p>
                        </AlertTitle>
                    )}
                    <div className="text-left text-[0.7rem] whitespace-break-spaces">{feedback}</div>
                </Alert>
            )}
        </div>
    );
